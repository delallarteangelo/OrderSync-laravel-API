...
class RecordedPaymentPayload
{
    ...
    public static function payment(RecordedPayment $payment): array
    {
        ...
        return [
            ...
            'subscriptionRequestId' => $payment->billingRecord?->subscription_request_id === null ? null : (string) $payment->billingRecord->subscription_request_id,
            'payer' => [
            ...
            'verifiedAmount' => $payment->verified_amount_minor === null ? null : $payment->verified_amount_minor / 100,
    ...
    public static function receipt(RecordedPayment $payment): array
    {
        ...
        return [
            ...
            'method' => $payment->method->value,
            'referenceNumber' => $payment->reference_number,
            'amount' => ($payment->verified_amount_minor ?? $payment->amount_minor) / 100,
            'currency' => $payment->currency,
