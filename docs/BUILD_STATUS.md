...
- React business behavior beyond authentication still depends on MSW fixtures.
...
- No business registration workflow, subscriptions, catalog, inventory, payment, notification, AI, or deployment implementation exists yet.
